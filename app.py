...
i = st.number_input(
    "Nhập lãi suất tiết kiệm theo năm (%)",min_value=0.0,value=6.0)
...
st.success(f"Tổng tiền nhận được theo lãi đơn: {A:,.4f} triệu đồng")
st.success(f"Tổng tiền nhận được theo lãi kép: {B:,.4f} triệu đồng")
